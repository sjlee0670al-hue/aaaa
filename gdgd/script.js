...
/* 즐겨찾기 */
const favorites=["Seoul","Busan","Jeju","Jeonju","Daegu","Ulsan","New York","Tokyo"];
...
function addFavorite(city){ if(!favorites.includes(city)){ favorites.push(city); renderFavorites(); } }
